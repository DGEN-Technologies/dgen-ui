...
window.addEventListener('load', async () => {
  ...
  await wait(() => ["dgen wallet", "bitcoin", "btc", "btcpayserver", "btcpay server"].some(v => ~(document.querySelector(".payment-method-list__item__info").innerText.toLowerCase().indexOf(v))));
