...
<LandingHeader {howItWorks} {roadmap} {faq} {about} {user} />
...
<style>
  ...
  .turquoise-cloud-section::before {
    ...
    bottom: 0;
    background:
      radial-gradient(ellipse 80% 50% at 20% 20%, rgba(116, 235, 213, 0.15) 0%, transparent 50%),
      radial-gradient(ellipse 60% 40% at 80% 40%, rgba(94, 238, 207, 0.12) 0%, transparent 50%),
      radial-gradient(ellipse 70% 45% at 40% 60%, rgba(106, 238, 199, 0.10) 0%, transparent 50%),
      radial-gradient(ellipse 65% 35% at 70% 80%, rgba(116, 235, 213, 0.08) 0%, transparent 50%);
    pointer-events: none;
    opacity: 1;
  }
  ...
  .purple-fade-section::before {
    ...
    bottom: 0;
    background:
      radial-gradient(ellipse 70% 50% at 30% 10%, rgba(116, 235, 213, 0.08) 0%, transparent 40%),
      radial-gradient(ellipse 80% 60% at 50% 50%, rgba(150, 136, 221, 0.15) 0%, transparent 60%),
      radial-gradient(ellipse 65% 45% at 70% 80%, rgba(184, 169, 232, 0.12) 0%, transparent 50%);
    pointer-events: none;
  }
  ...
  .faq-dark-section::before {
    ...
    height: 40%;
    background:
      radial-gradient(ellipse 70% 60% at 50% 0%, rgba(150, 136, 221, 0.08) 0%, transparent 70%);
    pointer-events: none;
  }
</style>
