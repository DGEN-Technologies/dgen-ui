...
<div class="space-y-5 pb-20">
  <h1 class="text-3xl mb-6 md:pt-12 font-bold">DGEN Wallet Bounties</h1>
  ...
  <p>
    Reach out to <a
      href="mailto:bounties@dgentech.io"
      class="text-blue-600 hover:underline">bounties@dgentech.io</a
