<script>
  ...
  import { PUBLIC_DOMAIN, PUBLIC_DGEN_URL } from "$env/static/public";
...
<div class="space-y-8 lg:text-xl mt-20 pt-20 md:pt-0 w-full max-w-full">
  ...
  <p class="text-secondary">
    DGEN Wallet is free and open source software. The code is available at <a
      href="https://github.com/dgentech"
      class="text-secondary underline">github.com/dgentech</a
    >
  </p>

  <p class="text-secondary">
    DGEN Wallet has a REST API that can be used to register accounts and make
  ...
  <h2 class="text-2xl">Liquid Network Support</h2>
  <p class="text-secondary">
    DGEN Wallet supports the Liquid Network for confidential Bitcoin
    transactions. Liquid provides faster settlements (1-minute blocks) and
    confidential transactions that hide amounts and asset types from blockchain
    observers.
  </p>
  <div class="text-secondary">
    <div>Key features:</div>
    <ul class="list-disc ml-8">
      <li>Confidential transactions - amounts are hidden</li>
      <li>1-minute block times for faster confirmations</li>
      <li>Support for USDt and other Liquid assets</li>
      <li>Lower fees than Bitcoin mainchain</li>
      <li>Atomic swaps between Lightning and Liquid</li>
    </ul>
  </div>
  <p class="text-secondary mt-4">
    Liquid transactions work similarly to Bitcoin transactions through our API,
    with automatic detection and routing based on the address format.
  </p>
