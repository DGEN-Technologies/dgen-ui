...
<section id="partners" class="relative py-10">
  <div class="container mx-auto px-2 sm:px-4 lg:px-6 relative z-10">
    ...
    <div
      class="max-w-4xl mx-auto grid grid-cols-1 sm:grid-cols-2 gap-6 sm:gap-10 items-stretch"
      in:fade={{ duration: 500, delay: 150 }}
    >
      <!-- Breez -->
      <div
        class="premium-card group flex items-start gap-2 sm:gap-4
      ...
      >
        ...
        <!-- Content -->
        <div class="flex-1">
          <h3 class="text-base sm:text-xl font-bold text-white mb-1">Breez</h3>
          <p class="text-xs sm:text-sm text-white/70 leading-relaxed">
            Non-custodial infrastructure providers with a focus is on empowering
      ...
      >
        ...
        >
          <img
            ...
            alt="PrivKey"
            class="w-10 h-10 sm:w-16 sm:h-16 object-contain rounded-xl sm:rounded-2xl"
          />
        </div>
