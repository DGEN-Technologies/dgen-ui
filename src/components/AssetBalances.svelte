      ...
      <div class="space-y-3">
        {#each balances as assetBalance}
          <div class="asset-item">
            <div
              class="flex items-center justify-between p-4 rounded-lg bg-base-200/50 hover:bg-base-200 transition-colors"
            >
