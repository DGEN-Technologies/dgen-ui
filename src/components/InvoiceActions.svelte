...
<div class="text-secondary space-y-2 text-xl pt-2">
  ...
  <!-- Network buttons moved to top of receive page -->
  ...
  <!-- More Options button temporarily disabled
  <button type="button" class="btn" onclick={toggleType}>
    <iconify-icon noobserver icon="ph:dots-three-bold" width="32"
    ></iconify-icon>
