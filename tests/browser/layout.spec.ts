  ...
  test("should detect missing browser features", async ({ page }) => {
    const result = await page.evaluate(() => {
      ...
      return {
        ...
        missingCryptoCompatible: Object.values(scenarios.missingCrypto).every(
          Boolean,
        ),
      };
    });
  ...
  test("should validate wallet store integration", async ({ page }) => {
    const result = await page.evaluate(async () => {
      try {
        ...
        return (
          typeof walletStore === "object" &&
          typeof walletStore.subscribe === "function"
        );
      } catch (error) {
        return false;
      }
  ...
  test("should validate crypto service integration", async ({ page }) => {
    const result = await page.evaluate(async () => {
      try {
        ...
        return (
          typeof crypto.encrypt === "function" &&
          typeof crypto.decrypt === "function"
        );
      } catch (error) {
        return false;
      }
    ...
    const result = await page.evaluate(async () => {
      try {
        ...
        return (
          ...
          typeof storage.retrieve === "function"
        );
      } catch (error) {
        return false;
      }
  ...
  test("should validate wallet service integration", async ({ page }) => {
    const result = await page.evaluate(async () => {
      try {
        ...
        return (
          typeof walletService.initWasm === "function" &&
